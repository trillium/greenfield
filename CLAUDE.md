...
**YOU ARE IN: `greenfield/polecats/obsidian/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/greenfield/` (rig root) or other directories
...
**Your mail address:** `greenfield/polecats/obsidian`
**Your rig:** greenfield
**Your Witness:** `greenfield/witness`
...
| Ask Witness for help | `gt mail send greenfield/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`greenfield/witness`) when:
...
```bash
gt mail send greenfield/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
